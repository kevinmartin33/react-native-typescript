...
export const getAsyncStorageItem = async (
  ...
  const response = await AsyncStorage.getItem(key, callback).catch(error => {
...
export const setAsyncStorageItem = async (
  ...
  const response = await AsyncStorage.setItem(key, value, callback).catch(
    error => {
...
export const removeAsyncStorageItem = async (
  ...
  const response = await AsyncStorage.removeItem(key, callback).catch(error => {
...
export const clearAsyncStorage = async (callback: any = undefined) => {
  const response = await AsyncStorage.clear(callback).catch(error => {
